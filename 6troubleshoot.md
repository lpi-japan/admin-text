...
```
# journalctl
 7月 19 11:48:51 localhost kernel: Linux version 5.14.0-570.12.1.el9_6.x86_64 (mockbuild@x64-builder02.almalinux.org) (gcc (GCC) 11.5.0 20240719 (R>
 7月 19 11:48:51 localhost kernel: The list of certified hardware and cloud instances for Red Hat Enterprise Linux 9 can be viewed at the Red Hat E>
 7月 19 11:48:51 localhost kernel: Command line: BOOT_IMAGE=(hd0,gpt2)/vmlinuz-5.14.0-570.12.1.el9_6.x86_64 root=/dev/mapper/almalinux_vbox-root ro>
 7月 19 11:48:51 localhost kernel: [Firmware Bug]: TSC doesn't count with P0 frequency!
 7月 19 11:48:51 localhost kernel: BIOS-provided physical RAM map:
（略）
```
...
```
# journalctl -u httpd
 7月 19 12:19:23 vbox systemd[1]: Starting The Apache HTTP Server...
 7月 19 12:19:23 vbox httpd[37922]: AH00558: httpd: Could not reliably determine the server's fully qualified domain name, using fe80::a00:27ff:fee>
 7月 19 12:19:23 vbox systemd[1]: Started The Apache HTTP Server.
 7月 19 12:19:23 vbox httpd[37922]: Server configured, listening on: port 80
```
...
合計 0
drwxr-sr-x+ 2 root systemd-journal 53  7月 20 12:32 65dd8a0b080e4373a5633404cabaac84
# ls -l /var/log/journal/3b71b9857a284561a3450996bf78a306/
合計 16384
-rw-r-----+ 1 root systemd-journal 8388608  7月 20 12:33 system.journal
-rw-r-----+ 1 root systemd-journal 8388608  7月 20 12:33 user-1000.journal
```
